...
function CarouselBackwardButton({currentPage, callback}: {currentPage: number; callback: (add: boolean) => void}) {
    return (
        <div
            className={clsx(
                "w-[10%] lg:w-[3%] absolute top-0 left-0 bottom-0 flex justify-center items-center cursor-pointer z-[15] rounded-e-md bg-black bg-opacity-50 hover:bg-opacity-70",
