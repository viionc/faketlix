...
function ProfilePage() {
    ...
    return (
        ...
        >
            ...
            <h1 className="text-2xl lg:text-[4rem] text-zinc-400">{manageProfiles ? "Manage Profiles" : "Who's Watching?"}</h1>
            <div className="w-full flex justify-center items-center flex-wrap gap-4 sm:mb-32">
                ...
                <div className="flex flex-col gap-2 justify-center items-center">
                    <div
                        ...
                        className="w-[7rem] h-[7rem] lg:w-[10rem] lg:h-[10rem] bg-zinc-900 justify-center items-center flex rounded-md cursor-pointer hover:scale-105 transition hover:bg-gray-100"
                    >
